    ...
    children: [
      {
        path: "dashboard",
        name: "Dashboard",
        component: () => import("@/views/product/dashboard/index"),
      ...
      },
      {
        ...
        meta: { title: "Sku管理", icon: "el-icon-s-home" },
      },
      {
        path: "trademark",
        name: "Trademark",
        component: () => import("@/views/product/trademark/index"),
        meta: { title: "品牌管理", icon: "el-icon-s-home" },
      },
      {
        path: "attr",
        name: "Attr",
        component: () => import("@/views/product/attr/index"),
        meta: { title: "属性管理", icon: "el-icon-s-home" },
      },
    ],
  },
  // {
